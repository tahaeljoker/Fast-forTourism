...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { href: getWhatsAppLink('Hello, I would like to contact you'), icon: 'fab fa-whatsapp', isWhatsApp: true },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-1 mb-6 lg:mb-0">
            <div className="flex items-center justify-center lg:justify-start mb-3">
              <Image src="/images/logo.png" alt="Logo" width={40} height={40} className="ms-2" />
              <h5 className="mb-0 font-bold text-xl">{t('fastForTourism')}</h5>
            </div>
            <p className="text-white/80 text-sm">{t('footerDesc')}</p>
            <div className="flex gap-3 justify-center lg:justify-start mt-4">
              {socialLinks.map(link => (
                <a 
                  ...
                  className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 hover:-translate-y-1 transition-all duration-300"
                >
          ...
          <div className="lg:col-span-1">
            <h5 className="uppercase font-bold mb-4 text-white">{t('quickLinks')}</h5>
          ...
          <div className="lg:col-span-1">
            <h5 className="uppercase font-bold mb-4 text-white">{t('contact')}</h5>
            <ul className="list-unstyled space-y-3 text-sm">
              ...
              <li className="flex items-start">
                ...
                <span className="text-white">{t('emailValue')}</span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-phone text-white/80 w-5 text-center mt-1 ms-2"></i>
                <span className="text-white">{t('phoneValue')}</span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-clock text-white/80 w-5 text-center mt-1 ms-2"></i>
                <span className="text-white">{t('workingHoursShort')}</span>
              </li>
            </ul>
          </div>
