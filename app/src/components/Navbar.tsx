        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center text-white hover:text-white space-x-2 group">
              <Image src="/images/logo.png" alt="Logo" width={30} height={30} className="group-hover:scale-110 transition-transform duration-300" priority />
            ...
            <div className="ms-auto flex items-center space-x-4 rtl:space-x-reverse">
              ...
              >
                <button 
                  ...
                  style={{ color: '#ffffff' }}
                >
                  <span className="text-lg transition-transform duration-300">{languages[currentLanguage].flag}</span>
