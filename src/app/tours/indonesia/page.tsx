    ...
    <div>
      ...
      <section className="py-20 text-center text-white relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #3B82F6 0%, #60A5FA 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>{t('indonesia')}</h1>
          <p className="max-w-3xl mx-auto text-lg md:text-xl">{t('indonesiaDesc')}</p>
        </div>
      </section>
      ...
      <section className="py-20">
        <Container>
          <Row className="align-items-center mb-5">
            <Col lg={6}>
              <h2 className="text-3xl font-bold mb-4">{t('discoverIndonesia')}</h2>
              <p className="text-gray-600 mb-4 text-lg">{t('indonesiaAbout1')}</p>
              <p className="text-gray-600 mb-4 text-lg">{t('indonesiaAbout2')}</p>
              <p className="text-gray-600 text-lg">{t('indonesiaAbout3')}</p>
            </Col>
            <Col lg={6}>
              <div className="relative h-96 rounded-lg overflow-hidden shadow-lg">
                <Image src="https://images.pexels.com/photos/2098428/pexels-photo-2098428.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt={t('indonesia')} fill className="object-cover" />
              </div>
            </Col>
          </Row>
        </Container>
