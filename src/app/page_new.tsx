    ...
    <main>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>{t('welcome')}</h1>
          <p className="max-w-3xl mx-auto text-lg md:text-xl mb-8">{t('bestTourist')}</p>
          <div className="flex justify-center items-center gap-4 flex-wrap">
            <Link href="/tours" className="hero-btn bg-white text-gray-800 font-bold py-3 px-6 rounded-full shadow-md hover:-translate-y-1 transition-all duration-300">
              <i className="fas fa-globe-americas me-2"></i>{t('explorDestinations')}
            </Link>
            <Link href="/contact" className="hero-btn bg-transparent border-2 border-white text-white font-bold py-3 px-6 rounded-full shadow-md hover:-translate-y-1 transition-all duration-300">
              <i className="fas fa-envelope me-2"></i>{t('contactUsBtn')}
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold section-title inline-block relative">{t('ourServices')}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div 
              className="p-8 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-white"
              style={getTransitionStyle(isMounted, 0)}
            >
              <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-6">
                <i className="fas fa-globe text-3xl text-[var(--primary-color)]"></i>
              </div>
              <h4 className="text-xl font-bold mb-3">{t('globalTourism')}</h4>
              <p className="text-gray-600">{t('globalTourismDesc')}</p>
            </div>
            <div 
              className="p-8 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-white"
              style={getTransitionStyle(isMounted, 200)}
            >
              <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-6">
                <i className="fas fa-passport text-3xl text-[var(--primary-color)]"></i>
              </div>
              <h4 className="text-xl font-bold mb-3">{t('visaServices')}</h4>
              <p className="text-gray-600">{t('visaServicesDesc')}</p>
            </div>
            <div 
              className="p-8 rounded-lg shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-white"
              style={getTransitionStyle(isMounted, 400)}
            >
              <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-6">
                <i className="fas fa-hotel text-3xl text-[var(--primary-color)]"></i>
              </div>
              <h4 className="text-xl font-bold mb-3">{t('hotelBookings')}</h4>
              <p className="text-gray-600">{t('hotelBookingsDesc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="destinations-section bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold section-title inline-block relative">{t('featuredDestinations')}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div style={getTransitionStyle(isMounted, 800, 600, -20)}>
              <h2 className="text-3xl font-bold mb-4 relative inline-block pb-2">
                <span className="bg-gradient-to-r from-[var(--primary-color)] to-[#4f46e5] bg-clip-text text-transparent font-extrabold">{t('specialOffers')}</span>
                <span className="absolute bottom-0 start-0 h-1 w-16 bg-[var(--primary-color)]"></span>
              </h2>
              <p className="text-lg text-gray-600 mb-6">{t('specialOffersDesc')}</p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center" style={getTransitionStyle(isMounted, 1000, 300, 10)}>
                  ...
                  <span className="text-gray-700">{t('discounts25')}</span>
                </li>
                <li className="flex items-center" style={getTransitionStyle(isMounted, 1100, 300, 10)}>
                  <span className="w-6 h-6 rounded-full bg-[var(--primary-color)] text-white flex items-center justify-center me-3 flex-shrink-0">
                    <i className="fas fa-check text-xs"></i>
                  </span>
                  <span className="text-gray-700">{t('groupFamilyOffers')}</span>
                </li>
                <li className="flex items-center" style={getTransitionStyle(isMounted, 1200, 300, 10)}>
                  <span className="w-6 h-6 rounded-full bg-[var(--primary-color)] text-white flex items-center justify-center me-3 flex-shrink-0">
                    <i className="fas fa-check text-xs"></i>
                  </span>
                  <span className="text-gray-700">{t('honeymoonPackages')}</span>
                </li>
                <li className="flex items-center" style={getTransitionStyle(isMounted, 1300, 300, 10)}>
                  <span className="w-6 h-6 rounded-full bg-[var(--primary-color)] text-white flex items-center justify-center me-3 flex-shrink-0">
                    <i className="fas fa-check text-xs"></i>
                  </span>
                  <span className="text-gray-700">{t('vipServices')}</span>
                </li>
              </ul>
    ...
    >
      <div className="relative h-64 w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 p-4">
          <h4 className="text-white text-xl font-bold">{t(countryKey)}</h4>
        </div>
      </div>
      <div className="p-6">
        <p className="text-gray-600 text-sm mb-4">Beautiful destination</p>
        <Link href={`/tours/${countryKey}`} className="w-full text-center block btn-explore rounded-full font-medium py-2 bg-[var(--primary-color)] text-white border-2 border-[var(--primary-color)] hover:bg-white hover:text-[var(--primary-color)] transition-all duration-300">
